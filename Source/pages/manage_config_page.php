	...
	<tr>
		...
		<td>
			...
			<label>
				...
				<span class="lbl"><?php echo plugin_lang_get( 'enable_linking' ) ?></span>
			</label><br>
			<label>
...
?>
			...
			<div class="widget-toolbox padding-8 clearfix">
				<input type="submit" class="btn btn-primary btn-white btn-sm btn-round" value="<?php echo plugin_lang_get( 'update_configuration' ) ?>" />
			</div>
		</div>
	</div>
